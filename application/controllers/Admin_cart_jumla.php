...
class Admin_cart_jumla extends CI_Controller{
     ...
     function index(){
        ...
        // Load the cart view
        $this->load->view('admin/sell_jumla',['cartItems'=>$cartItems,'datay'=>$datay,'limit'=>$limit,'my'=>$my,'kwisha'=>$kwisha,'selected_branch_id'=>$branch_id,'discount_rules'=>$discount_rules,'product_categories'=>$product_categories]);
    }
