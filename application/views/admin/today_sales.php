...
<div class="body">
    <form method="get" action="<?php echo base_url('admin/sales_today'); ?>" class="evamo-live-filter">
        ...
        <div class="evamo-filter-actions">
            ...
            <a href="<?php echo base_url('admin/sales_today'); ?>" class="btn btn-secondary">Reset</a>
        </div>
    </form>
