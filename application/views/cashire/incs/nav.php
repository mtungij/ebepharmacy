        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right evamo-topbar-menu evamo-apps-menu">
                ...
                <div class="evamo-apps-grid">
                    <a href="<?php echo base_url("cashire/dashboard") ?>"><i class="icon-home"></i><span>Dashboard</span></a>
                    <a href="<?php echo base_url("cashire/today_salles") ?>"><i class="icon-list"></i><span>Today Sales</span></a>
                    <a href="<?php echo base_url("cashire/cash_flow") ?>"><i class="icon-graph"></i><span>Cash Flow</span></a>
                    <a href="<?php echo base_url("cashire/view_order_confirmd") ?>"><i class="icon-check"></i><span>Orders</span></a>
                </div>
            </div>
        </div>
