        ...
        <div class="tab-pane active" id="menu">
            <nav class="sidebar-nav">
                <ul class="main-menu metismenu">
                    <li><a href="<?php echo base_url("cashire/dashboard") ?>"><?php echo evamo_heroicon('home'); ?><span>Dashboard</span></a></li>
                    <li><a href="javascript:void(0);" class="has-arrow"><?php echo evamo_heroicon('chart'); ?><span>Today sales</span></a>
                        <ul>
                            <li><a href="<?php echo base_url("cashire/today_salles") ?>">General sales Report</a></li>
                            <li><a href="<?php echo base_url("cashire/retail_sale") ?>">RetailSale Report</a></li>
                            <li><a href="<?php echo base_url("cashire/whore_sale"); ?>">WholeSale Report</a></li>
                        </ul>
                    </li>
                    <li><a href="<?php echo base_url("cashire/cash_flow") ?>"><?php echo evamo_heroicon('banknotes'); ?><span>Cash Flow</span></a></li>
                    <li><a href="<?php echo base_url("cashire/view_order_confirmd") ?>"><?php echo evamo_heroicon('check-badge'); ?><span>Order confirmed</span></a></li>
                </ul>
            </nav>
        </div>
    </div>
