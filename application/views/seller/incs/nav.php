        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right evamo-topbar-menu evamo-apps-menu">
                ...
                <div class="evamo-apps-grid">
                    <a href="<?php echo base_url("seller/index") ?>"><i class="icon-home"></i><span>Sale</span></a>
                    <a href="<?php echo base_url("seller/today_salles") ?>"><i class="icon-list"></i><span>Today Sales</span></a>
                    <a href="<?php echo base_url("seller/retail_sale") ?>"><i class="icon-basket"></i><span>Retail</span></a>
                    <a href="<?php echo base_url("seller/cash_flow") ?>"><i class="icon-graph"></i><span>Cash Flow</span></a>
                </div>
            </div>
        </div>

        <div class="dropdown evamo-nav-profile-dropdown">
            <a href="javascript:void(0);" class="dropdown-toggle icon-menu evamo-nav-profile-toggle" data-toggle="dropdown">
                <img src="<?php echo $profile_img; ?>" alt="User" class="evamo-nav-profile-avatar">
                <span class="evamo-nav-profile-name"><?php echo $_SESSION['full_name']; ?></span>
            </a>
